...
export const ko: Dict = {
  ...
  'settings.queueEnabled': '전송 대기열',
  'settings.queueEnabledHint': '실행 중에 Stop 옆 대기열 버튼이나 ⌘⇧⏎(Cmd+Shift+Enter, Windows는 Ctrl+Shift+Enter)로 다음 프롬프트를 대기열에 추가합니다. 현재 실행이 끝나면 자동으로 전송됩니다.',
